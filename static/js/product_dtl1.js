  ...
  function updateProductList() {
    $.ajax({
      ...
      success: function (data) {
        if (data.products == "There is no such a product") {
          $(".main-section-productDtl").text(data.products);

          $(".main-section-productDtl").css({
            "font-size": "3rem",
            "text-align": "center",
            "margin-block": "3rem",
          });
                ...
                $.ajax({
                  ...
                  success: function (data) {
                    ...
                    $(btn_name)
                      ...
                      .on("click", function () {
                        if (
                          $(".delete-before-product-product.active").length ===
                          1
                        ) {
                          document.cookie =
